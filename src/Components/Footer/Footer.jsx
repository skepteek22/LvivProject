    ...
    <div className="footer">
      <div className="footer__wrapper">
        ...
        <div className="footer__lviv">
          <h3>Lviv</h3>
          <p>Write us</p>
          <a href="tel:+380972233322" target="_blank">+38 097 22 333 22</a>
          <br/>
          <a href="https://maps.app.goo.gl/mxZf9RQabxxjEj8u9" target="_blank">
            SEE ON MAP
            <img src="public\svg\Arrow 3.svg" alt="arrow" />
          </a>
        </div>

        <div className="footer__social">
          <h3>Social</h3>
          <a href="mailto:lvivtraveling@lnu.edu.ua" target="_blank">lvivtraveling@lnu.edu.ua</a>
          <a href="tel:+380972233322" target="_blank">+38 097 22 333 22</a>
        ...
        <div className="footer__newsletter">
          ...
          <div className="newsletter__social-list">
            <ul>
              ...
              <li>
                <a href="">
                  <img src="public\svg\threads.svg" alt="threads" />
                </a>
              </li>
            </ul>
          </div>
